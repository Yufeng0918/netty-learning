...
public final class StudentServiceGrpc {
  ...
  public static final String SERVICE_NAME = "com.bp.netty.proto.StudentService";
  ...
  public static final io.grpc.MethodDescriptor<MyRequest,
      ...
      io.grpc.MethodDescriptor.<MyRequest, MyResponse>newBuilder()
          ...
          .setFullMethodName(generateFullMethodName(
              "com.bp.netty.proto.StudentService", "GetRealNameByUsername"))
  ...
  public static final io.grpc.MethodDescriptor<StudentRequest,
      ...
      io.grpc.MethodDescriptor.<StudentRequest, StudentResponse>newBuilder()
          ...
          .setFullMethodName(generateFullMethodName(
              "com.bp.netty.proto.StudentService", "GetStudentsByAge"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
  ...
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<StudentRequest,
      com.bp.netty.protoc.StudentResponseList> METHOD_GET_STUDENT_LIST_BY_AGES =
      io.grpc.MethodDescriptor.<StudentRequest, com.bp.netty.protoc.StudentResponseList>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
          .setFullMethodName(generateFullMethodName(
              "com.bp.netty.proto.StudentService", "GetStudentListByAges"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              StudentRequest.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.bp.netty.protoc.StudentResponseList.getDefaultInstance()))
          .build();
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<StreamRequest,
      ...
      io.grpc.MethodDescriptor.<StreamRequest, StreamResponse>newBuilder()
          ...
          .setFullMethodName(generateFullMethodName(
              "com.bp.netty.proto.StudentService", "BiTalk"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
  ...
  public static abstract class StudentServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<StudentRequest> getStudentListByAges(
        io.grpc.stub.StreamObserver<com.bp.netty.protoc.StudentResponseList> responseObserver) {
      return asyncUnimplementedStreamingCall(METHOD_GET_STUDENT_LIST_BY_AGES, responseObserver);
    }
    ...
    @Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
            METHOD_GET_STUDENT_LIST_BY_AGES,
            asyncClientStreamingCall(
              new MethodHandlers<
                StudentRequest,
                com.bp.netty.protoc.StudentResponseList>(
  ...
  public static final class StudentServiceStub extends io.grpc.stub.AbstractStub<StudentServiceStub> {
    ...
    public io.grpc.stub.StreamObserver<StudentRequest> getStudentListByAges(
      ...
      return asyncClientStreamingCall(
          getChannel().newCall(METHOD_GET_STUDENT_LIST_BY_AGES, getCallOptions()), responseObserver);
    }
      ...
      synchronized (StudentServiceGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(METHOD_GET_STUDENT_LIST_BY_AGES)
